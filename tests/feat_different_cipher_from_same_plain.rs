//! Test if SerdeEncryptPublicKey and SerdeEncryptSharedKey emits different cipher-text for the same plain-text to avoid attacks such as statistical analysis of cipher-text.
